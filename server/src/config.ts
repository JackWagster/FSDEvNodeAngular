...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'FSDEvNodeAngular';
    ...
    'jhipster.mail.from' = 'FSDEvNodeAngular@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'FSDEvNodeAngular API';
    'jhipster.swagger.description' = 'FSDEvNodeAngular API documentation';
    ...
    'eureka.instance.appname' = 'FSDEvNodeAngular';
    'eureka.instance.instanceId' = 'FSDEvNodeAngular:${random.value}';
    ...
    'cloud.config.name' = 'FSDEvNodeAngular';
